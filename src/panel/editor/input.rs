...
use crate::panel::editor::config::{char_config, vec_config};
...
pub fn handle_input(editor: &Editor, input_event: InputEvent) -> EditorEvent {
    match editor.mode {
        ...
        EditorMode::Command => handle_command_mode_input(editor, input_event),
    }
}
...
fn handle_command_mode_input(editor: &Editor, input_event: InputEvent) -> EditorEvent {
    todo!()
}